...
class FactsTest < ApplicationSystemTestCase
  ...
  test "creating a Fact" do
    ...
    fill_in "Fact Category", with: @fact.fact_category
    fill_in "Fact Content", with: @fact.fact_content
    fill_in "Fact Image", with: @fact.fact_image
    fill_in "Fact Title", with: @fact.fact_title
    fill_in "Track", with: @fact.track_id
