...
class TracksTest < ApplicationSystemTestCase
  ...
  test "creating a Track" do
    ...
    fill_in "Track Audio", with: @track.track_audio
    fill_in "Track Description", with: @track.track_description
    fill_in "Track Image", with: @track.track_image
    fill_in "Track Metering Levels", with: @track.track_metering_levels
